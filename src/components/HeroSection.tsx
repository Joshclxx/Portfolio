...
// const HeroSection = () => {
//   return (
//     <SectionContainer background="relative overflow-hidden bg-[#1B263B] hero-background mt-4">
//       {/* Floating Elements */}
//       <div className="absolute inset-0 pointer-events-none">
//         <div className="floating-box top-[20%] left-[10%]" />
//         <div className="floating-box top-[60%] right-[15%] animation-delay-[2s]" />
//         <div className="floating-box bottom-[30%] left-[20%] animation-delay-[4s]" />
//       </div>
...
//           download
//           className="w-[164px] h-[42px] border border-[#64FFDA] bg-[#64FFDA]/45 rounded-lg flex items-center justify-center hover:bg-transparent font-bold"
//           initial={{ opacity: 0, y: 20 }}
//           whileInView={{ opacity: 1, y: 0 }}
//           viewport={{ once: false, amount: 0.5 }}
//           transition={{ delay: 0.6 }}
